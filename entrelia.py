...
if check_password():
    ...
    /* Ocultar cosas seguras */
    [data-testid="stDecoration"]   { display: none !important; }
    [data-testid="stStatusWidget"] { display: none !important; }
    .stDeployButton                { display: none !important; }
    [data-testid="stMainMenu"]     { display: none !important; }

    /* SOLO ocultar links (GitHub) sin tocar botones */
            ...
            if st.button("🕵️ Escanear con IA"):
                with st.spinner("🤖 Evo Q está leyendo tu ticket..."):
                    try:
                        ...
                        # --- AGREGADO: DEBUG VISUAL (RESPUESTA CRUDA) ---
                        st.write("🔍 **DEBUG - Respuesta cruda de la IA:**")
                        try:
                            st.write(res_ia.text)
                        except Exception as debug_e:
                            st.write("La IA no devolvió texto válido. Error:", debug_e)
                        ...
                        st.write("🔍 **DEBUG - Detalle exacto del error:**")
                        st.exception(e_ia)
