        ...
        if not df_master.empty:
            ...
            if not movs_activos.empty:
                ...
                if st.button("Confirmar Anulación") and motivo:
                    ...
                    # Revisamos el detalle actual: si es nulo o vacío, lo dejamos como texto limpio
                    ...
                    # Creamos la etiqueta de anulación
                    ...
                    st.success("✅ Movimiento anulado y registrado en el historial.")
                    st.rerun()
            else:
